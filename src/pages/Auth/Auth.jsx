...
function LogIn() {
  ...
  const handleLogin = async (e) => {
    ...
    const formData = { //Why It's Needed:The formData object is passed as the body in the fetch call
      username: username,
      password: password,
    };
  ...
  return (
    ...
    <div className="a-right">
      ...
      <form className="infoForm authForm" onSubmit={handleLogin}>
        <h3>
        <div><img src={Logo} alt="Logo" className="small-logo" /></div>
          Log In
          </h3>
